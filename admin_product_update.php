...
if (isset($_POST['update_product'])) {
    ...
    $category = $_POST['category']; // Retrieve category from the form
    ...
    $update_product = $conn->prepare("UPDATE `products` SET name = ?, price = ?, category = ? WHERE id = ?");
    ...
    <section class="update-product">
        ...
        ?>
                <form action="" enctype="multipart/form-data" method="post">
                    ...
                    <input type="text" class="box" required maxlength="100" placeholder="Enter product category" name="category" value="<?= $fetch_products['category']; ?>"> <!-- Add this line for category -->
